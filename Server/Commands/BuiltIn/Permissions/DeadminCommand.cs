...
namespace DedicatedServerMod.Server.Commands.BuiltIn.Permissions
{
    ...
    public class DeadminCommand(PlayerManager playerMgr) : BaseServerCommand(playerMgr)
    {
        ...
        public override void Execute(CommandContext context)
        {
            ...
            if (context.Permissions?.UnassignGroup(context.Executor?.TrustedUniqueId, targetId, Shared.Permissions.PermissionBuiltIns.Groups.Administrator, "deadmin command") == true)
            {
