...
[![Version](https://img.shields.io/badge/version-0.6.0--beta-blue)](https://github.com/ifBars/S1DedicatedServers/releases)
...
Current release status: `0.6.0-beta`. The project is usable, but the runtime and public API are still evolving. Minimal support will be provided until a full non-beta release is made.
