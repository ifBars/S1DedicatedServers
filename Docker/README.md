...
- Persist `/home/steam/game` so the installed game files and generated config survive container recreation. Runtime bootstrap state such as the Wine prefix is managed outside this directory by the image.
